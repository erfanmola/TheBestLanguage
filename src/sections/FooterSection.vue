    ...
    <div>
        ...
        <footer id="footer" v-once>
            ...
            <div class="holder">
                ...
                <a href="https://github.com/erfanmola/TheBestLanguage" target="_blank" rel="noopener" title="Github">مشارکت در توسعه پروژه</a>
...
export default {
    ...
    data() {
        ...
        return {
            ...
            DevelopixProjectsContext: 'thebestlanguage',
        }
